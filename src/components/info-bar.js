...
const InfoBar = () => {
  return (
    <div className="flex md:flex-row flex-col justify-evenly max-w-6xl text-yellow-100 m-auto chivo-reg">
      <div className="md:w-1/3 p-4 flex justify-center items-center bg-gray-900 opacity-95">
        <div className="ml-2">
