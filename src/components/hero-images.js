...
const HeroImages = () => {
  ...
  return (
    <BackgroundImage
      className="w-full flex flex-col justify-center md:justify-evenly hero items-start h-full"
      fluid={source}
    >
      <div className="flex md:items-start flex-col w-2/3 md:w-1/2 md:p-5 ">
